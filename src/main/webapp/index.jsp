...
<title>Health Care</title>
     ...
     <link rel="stylesheet" href="assests/client/css/owl.theme.default.min.css">
					...
					<div class="team-thumb wow fadeInUp" data-wow-delay="0.2s">
						...
						<div class="team-info">
							...
							<div class="team-contact-info">
								...
								<p>
									<i class="fa fa-envelope-o"></i> <a href="#">general@company.com</a>
								</p>
							</div>
					...
					<div class="team-thumb wow fadeInUp" data-wow-delay="0.4s">
						...
						<div class="team-info">
							...
							<div class="team-contact-info">
								...
								<p>
									<i class="fa fa-envelope-o"></i> <a href="#">pregnancy@company.com</a>
								</p>
							</div>
							<ul class="social-icon">
					...
					<div class="team-thumb wow fadeInUp" data-wow-delay="0.6s">
						...
						<div class="team-info">
							...
							<div class="team-contact-info">
								...
								<p>
									<i class="fa fa-envelope-o"></i> <a href="#">cardio@company.com</a>
								</p>
							</div>
							<ul class="social-icon">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="news-thumb wow fadeInUp" data-wow-delay="0.4s">
						<a href="news-detail.html"> <img src="images/news-image1.jpg"
						...
						<div class="news-info">
							...
							<p>Maecenas risus neque, placerat volutpat tempor ut,
								vehicula et felis.</p>
							<div class="author">
								<img src="images/author-image.jpg" class="img-responsive" alt="">
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="news-thumb wow fadeInUp" data-wow-delay="0.6s">
						<a href="news-detail.html"> <img src="images/news-image2.jpg"
							class="img-responsive" alt="">
						</a>
						<div class="news-info">
							...
							<p>Fusce vel sem finibus, rhoncus massa non, aliquam velit.
								Nam et est ligula.</p>
							<div class="author">
								<img src="images/author-image.jpg" class="img-responsive" alt="">
								<div class="author-info">
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="news-thumb wow fadeInUp" data-wow-delay="0.8s">
						<a href="news-detail.html"> <img src="images/news-image3.jpg"
							class="img-responsive" alt="">
						</a>
						<div class="news-info">
							...
							<p>Vivamus non nulla semper diam cursus maximus. Pellentesque
								dignissim.</p>
							<div class="author">
								<img src="images/author-image.jpg" class="img-responsive" alt="">
								<div class="author-info">
